                ...
                <div class="forms-cont" id="signInSection">
                    <div class="login-form">
                        <form  th:action="@{/login}" method="post" class="form-inputs" name="loginForm">
                            ...
                            <div class="form-group">
                                <label class="input-label" for="username"><i class="fas fa-user"></i> User Name</label>
                                <input type="text" class="form-control" name="username" id="username"type="text" id="username" name="username"
                                       placeholder="user name" />
                            </div>
                            <div class="form-group">
                                <label class="input-label" for="Password"><i class="fas fa-key"></i> Password</label>
                    ...
                    <div class="register-form">
                        <form onsubmit="return myFunction()" class="form-inputs" id="myform" name="signInForm">
                            ...
                            <div class="form-group">
                                <label class="input-label" for="name"><i class="fas fa-user"></i> Name*</label>
                                <input type="text" class="form-control" name="name" id="name"
                                       placeholder="your name"/>
                            </div>
                            <div class="form-group">
                                <label class="input-label" for="username2"><i class="fas fa-key"></i> User Name*</label>
                                <input type="text" class="form-control" name="userName" id="username2"
                                       placeholder="user name" />
                            </div>
                            <div class="form-group">
                                <label class="input-label" for="password2"><i class="fas fa-check-double"></i>Password*</label>
